  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex justify-between items-center mb-10">
        <div>
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100">My Boards</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage your Kanban boards</p>
        </div>
        <CreateBoardButton />
      </div>
